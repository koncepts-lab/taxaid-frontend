...
ap_data = {
  ...
  "historicalMovement": {
    "apBalance": [1.6, 3.2, 3.8, 4.3, 4.6, 4.8],
    "percentage": [],
...
content_str = json.dumps(ap_data, ensure_ascii=False, indent=2)

comment_block = """  "__comment: accounts-payable page": "============================================================",
  "__comment: accounts-payable page": "  PAGE → pages/accounts-payable/index.vue | URL → /accounts-payable ",
  "__comment: accounts-payable page": "  Summary, Top Customers, Historical Movement, Aging Graph ",
  "__comment: accounts-payable page": "============================================================",
  "accountsPayablePage": """
...
print('Updated data.json for accounts-payable')
