<template>
  <header class="flex items-center justify-between px-8 py-4 bg-transparent mt-0 mb-2">
    ...
    <div class="hidden lg:flex items-center border border-[#B2E4D9] p-1.5 rounded-full" style="background: linear-gradient(271.49deg, rgba(164, 227, 214, 0.485) 30.96%, rgba(109, 216, 193, 0.5) 109.26%); box-shadow: 0px 4px 4px 0px #D0F7EF80;">
      ...
      <button class="px-7 py-2.5 rounded-full text-black/70 hover:text-black font-medium transition-all text-[16px]">
        Data Source
      </button>
      <button class="px-7 py-2.5 rounded-full text-black/70 hover:text-black font-medium transition-all text-[16px]">
        Alerts
    ...
    <div class="flex items-center gap-7">
        ...
        <div class="absolute top-[110%] right-0 mt-2 w-[324px] bg-white rounded-3xl shadow-[0_10px_40px_rgba(0,0,0,0.1)] opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-300 z-50 p-4 border border-teal-50">
          <div class="flex flex-col gap-1">
            ...
            >
              ...
              <span class="text-[#013E32] font-medium text-[15px]">{{ item.label }}</span>
            </div>
          </div>
        </div>
      </div>
      ...
      <!-- PROFILE SECTION -->
      <div class="flex items-center gap-4 ml-3 p-1">
        <div class="text-right hidden sm:block">
          <div class="text-[#013E32] font-medium text-[15px] leading-tight">Masterline Mech</div>
...
const settingsItems = [
  { label: 'Subscription Management', icon: '/images/icons/Subscription-Management.svg' },
  { label: 'Support', icon: '/images/icons/Support.svg' },
  { label: 'Notification Preferences', icon: '/images/icons/Notification-Preferences.svg' },
  { label: 'Security & Privacy', icon: '/images/icons/Security-Privacy.svg' },
  { label: 'Sync & Data Management', icon: '/images/icons/Sync-Data-Management.svg' },
]
</script>
