                                ...
                                <div v-if="showDateDropdown"
                                    ...
                                    <div v-for="period in periods" :key="period.en" class="relative group">
                                        ...
                                        <div v-if="(period.en === 'Custom Range' || period.en === 'Custom Date') && selectedPeriodKey === period.en"
                                            ...
                                            <div v-if="selectedPeriodKey === 'Custom Range'" class="flex flex-col lg:flex-row">
                                                <div class="p-3">
                                                ...
                                                <div class="p-3 border-t lg:border-t-0 lg:border-l" :class="isDark ? 'border-white/10' : 'border-gray-100'">
