    ...
    <div class=" ">
        <div class="container mx-auto px-6">
            <div class="flex items-center justify-between">
                <!-- Title Section -->
                <div>
                    <h1 class="text-2xl font-medium text-primary-450">Revenue Analysis</h1>
                    <p class="text-sm text-black/59 mt-1">Comprehensive revenue tracking and insights</p>
                </div>
                ...
                <div class="flex items-center space-x-3">
                    ...
                    <button
                        ...
                        <img src="/images/icons/reload.svg" alt="Reload Icon" class="w-5 h-5" />
                    </button>
