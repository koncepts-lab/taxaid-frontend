<template>
  <div class="w-full overflow-hidden transition-all duration-500 rounded-3xl"
    :class="isDark ? 'bg-[#00141080]' : 'bg-white shadow-sm border border-gray-100'">
    ...
    <table class="w-full text-left rtl:text-right border-collapse">
        ...
        <template v-for="(group, gIdx) in arData" :key="gIdx">
          ...
          <tr v-if="expandedGroups.includes(gIdx)">
            <td colspan="6" class="p-0">
              <div class="bg-[#E6F4F1] dark:bg-[#A2E8D6] p-8">
      ...
      <tfoot>
        <tr class="bg-[#E6F4F1] dark:bg-[#68E4C4] transition-all duration-500">
