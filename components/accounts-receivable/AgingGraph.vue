<template>
  <div class="aging-graph-card rounded-3xl p-8 h-full flex flex-col relative transition-all duration-500 overflow-hidden shadow-md">
    <!-- Header -->
