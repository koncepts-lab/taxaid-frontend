...
<<<<<<< HEAD
            <div v-if="sending" class="text-xs" :class="isDark ? 'text-white/50' : 'text-black/50'">Akeel is typing...</div>
=======
            <div v-if="sending" class="text-xs text-black/50">{{ sendingStatusText }}</div>
>>>>>>> 7a1e248e59ea17c1487e938963a73b539e57066f
...
<<<<<<< HEAD
            ...
            <div class="relative">
                <span class="absolute lg:left-4 left-2 top-1/2 -translate-y-1/2 text-gray-400 text-lg">
                    <img src="/images/icons/pin.svg" :class="['w-5 h-5', isDark ? 'invert opacity-50' : '']" alt="Chat Icon" />
=======
...
<<<<<<< HEAD
                    :class="['w-full border rounded-xl lg:py-4 py-2 pl-12 pr-10 text-sm placeholder:font-semibold focus:outline-none focus:ring-1 focus:ring-emerald-400', isDark ? 'bg-transparent border-white/20 text-white placeholder:text-white/40' : 'bg-white border-primary-100 text-[#000] placeholder:text-[#b9b9b9]']" />
=======
