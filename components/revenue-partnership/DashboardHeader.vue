  ...
  <header class="h-[110px] w-full flex items-center justify-between px-8 bg-transparent relative z-20">
    ...
    <div class="flex items-center gap-6">
      ...
      <div class="flex items-center gap-4 ml-[-8px]">
        ...
        <!-- Notifications -->
        <button class="w-[38px] h-[38px] rounded-full bg-[#00896F]/40 border border-[#ffffff1A] flex items-center justify-center text-white hover:bg-[#00896F]/60 transition-colors cursor-pointer">
          <img src="/images/icons/Notifications.svg" alt="Notifications" class="w-5 h-5 invert brightness-0" />
        </button>
        
        <NuxtLink to="/revenue-partnership-login" class="flex items-center gap-2 bg-white h-[38px] px-4 rounded-[8px] hover:bg-gray-50 transition-colors shadow-sm text-[13px] font-medium text-[#1a1a1a] cursor-pointer">
          <svg xmlns="http://www.w3.org/2000/svg" class="h-[16px] w-[16px] text-[#1a1a1a]" fill="none" viewBox="0 0 24 24" stroke="currentColor">
