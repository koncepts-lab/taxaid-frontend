  ...
  <div class="w-full overflow-hidden transition-all duration-500 rounded-3xl"
              ...
              <td class="px-6 py-5 text-center">
                <div class="relative w-[65px] h-[32px] overflow-hidden mx-auto">
                  <svg viewBox="0 0 100 50" class="w-full h-full">
                    <path d="M 10,50 A 40,40 0 0 1 90,50" fill="none" :stroke="isDark ? '#FFFFFF20' : '#E5E7EB'"
                      stroke-width="12" stroke-linecap="round" />
                    <path d="M 10,50 A 40,40 0 0 1 90,50" fill="none" :stroke="gaugeColor(item.progress)"
            ...
            <td class="px-6 py-5 text-center">
              <div class="relative w-[65px] h-[32px] overflow-hidden mx-auto">
                <svg viewBox="0 0 100 50" class="w-full h-full">
                  <path d="M 10,50 A 40,40 0 0 1 90,50" fill="none" :stroke="isDark ? '#FFFFFF20' : '#E5E7EB'"
                    stroke-width="12" stroke-linecap="round" />
                  <path d="M 10,50 A 40,40 0 0 1 90,50" fill="none" :stroke="gaugeColor(grossProfit.progress)"
                    stroke-width="12" stroke-linecap="round" :stroke-dasharray="251"
    ...
    <Teleport to="body">
      <div v-if="isModalOpen"
        ...
        <div class="w-full max-h-[90vh] rounded-xl flex flex-col overflow-hidden"
          ...
          <div class="flex justify-between items-center py-6 px-8 border-b"
            ...
            <button @click="isModalOpen = false"
              ...
              <img :src="isDark ? '/images/icons/expand-white.svg' : '/images/icons/expand-dark.svg'" alt="Close Modal"
                ...
                :class="[isDark ? '' : '', currentLang === 'ar' ? 'scale-x-[-1]' : '']" />
            </button>
          </div>
