                        ...
                        <Transition name="dropdown">
                            <div v-if="showExportDropdown"
                                ...
                                <button @click="triggerExport('pdf')"
                                    class="w-full px-4 py-3 text-sm rounded-lg flex items-center hover:bg-red-100 text-black">
...
const emit = defineEmits(['selected-date', 'reload', 'export-pdf', 'one-click-summary'])
