<template>
  <div class="p-8 space-y-6 min-h-[calc(100vh-90px)] bg-[#F8F9FA]">
    ...
    <!-- Back Button -->
    <button @click="$router.back()" class="flex items-center gap-2 text-sm font-medium text-gray-500 hover:text-[#00896F] mb-2 transition-colors w-fit">
    ...
    <!-- 1. Header Card (Green) -->
    <div class="rounded-2xl p-8 text-white flex gap-6 items-center shadow-sm relative overflow-hidden" style="background-color: #004D40;">
      ...
      <div class="flex-1 z-10">
        ...
        <div class="flex gap-12">
          <div>
            <p class="text-[#8EFDE0] text-xs mb-1">EIN</p>
            <p class="text-sm text-white/90">{{ profile.ein }}</p>
          </div>
          <div>
            <p class="text-[#8EFDE0] text-xs mb-1">Entity Type</p>
            <p class="text-sm text-white/90">{{ profile.entityType }}</p>
          </div>
          <div>
            <p class="text-[#8EFDE0] text-xs mb-1">Founded</p>
    ...
    <div class="bg-white rounded-2xl p-6 border border-gray-100 shadow-sm">
      ...
      <div v-if="!isEditing" class="grid grid-cols-1 md:grid-cols-2 gap-4">
        <div class="bg-[#F8FAF9] border border-[#E9F3F0] rounded-xl p-4 flex items-center gap-4">
      ...
      <div v-else class="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-4">
        <div>
          ...
          <input v-model="profile.firstName" class="w-full bg-white border border-gray-200 rounded-lg px-3 py-2 text-sm focus:outline-none focus:border-[#00896F]" />
        </div>
        <div>
          <label class="block text-xs text-gray-700 mb-1">Last Name</label>
          <input v-model="profile.lastName" class="w-full bg-white border border-gray-200 rounded-lg px-3 py-2 text-sm focus:outline-none focus:border-[#00896F]" />
        </div>
        <div>
          <label class="block text-xs text-gray-700 mb-1">Company Name</label>
          <input v-model="profile.companyName" class="w-full bg-white border border-gray-200 rounded-lg px-3 py-2 text-sm focus:outline-none focus:border-[#00896F]" />
        </div>
        <div>
          ...
          <input v-model="profile.companyNickname" maxlength="15" class="w-full bg-white border border-gray-200 rounded-lg px-3 py-2 text-sm focus:outline-none focus:border-[#00896F]" />
        </div>
        <div>
          ...
          <div class="relative">
             ...
             <input v-model="profile.email" class="w-full pl-9 bg-white border border-gray-200 rounded-lg px-3 py-2 text-sm focus:outline-none focus:border-[#00896F]" />
          </div>
        </div>
        <div>
          ...
          <div class="relative">
             ...
             <input v-model="profile.phone" class="w-full pl-9 bg-white border border-gray-200 rounded-lg px-3 py-2 text-sm focus:outline-none focus:border-[#00896F]" />
          </div>
        </div>
        <div>
          <label class="block text-xs text-gray-700 mb-1">EIN</label>
          <input v-model="profile.ein" class="w-full bg-white border border-gray-200 rounded-lg px-3 py-2 text-sm focus:outline-none focus:border-[#00896F]" />
        </div>
        <div>
          <label class="block text-xs text-gray-700 mb-1">Entity Type</label>
          <input v-model="profile.entityType" class="w-full bg-white border border-gray-200 rounded-lg px-3 py-2 text-sm focus:outline-none focus:border-[#00896F]" />
        </div>
        <div>
          <label class="block text-xs text-gray-700 mb-1">Founded Year</label>
          <input v-model="profile.founded" maxlength="4" placeholder="e.g. 2015" class="w-full bg-white border border-gray-200 rounded-lg px-3 py-2 text-sm focus:outline-none focus:border-[#00896F]" />
        </div>
        <div>
          <label class="block text-xs text-gray-700 mb-1">Industry</label>
          <input v-model="profile.industry" class="w-full bg-white border border-gray-200 rounded-lg px-3 py-2 text-sm focus:outline-none focus:border-[#00896F]" />
        </div>
        <div>
          <label class="block text-xs text-gray-700 mb-1">Fiscal Year End</label>
          <input v-model="profile.fiscalYearEnd" class="w-full bg-white border border-gray-200 rounded-lg px-3 py-2 text-sm focus:outline-none focus:border-[#00896F]" />
        </div>
      </div>
    </div>
    ...
    <div class="bg-white rounded-2xl p-6 border border-gray-100 shadow-sm">
      ...
      <div class="space-y-6">
        <div>
          <h4 class="text-sm text-gray-500 mb-4">Permanent Address</h4>
          
          <div class="bg-[#F8FAF9] border border-[#E9F3F0] rounded-xl p-4 flex items-start gap-4">
            ...
            <div v-else class="flex-1 space-y-4 py-1">
              <div>
                ...
                <input v-model="profile.permanentAddress.street" class="w-full bg-white border border-gray-200 rounded-lg px-3 py-2 text-sm focus:outline-none focus:border-[#00896F]" />
              </div>
              <div class="flex gap-4">
                <div class="flex-1">
                  <label class="block text-xs text-gray-700 mb-1">City</label>
                  <input v-model="profile.permanentAddress.city" placeholder="City" class="w-full bg-white border border-gray-200 rounded-lg px-3 py-2 text-sm focus:outline-none focus:border-[#00896F]" />
                </div>
                <div class="w-1/3">
                  <label class="block text-xs text-gray-700 mb-1">State</label>
                  <input v-model="profile.permanentAddress.state" placeholder="State" class="w-full bg-white border border-gray-200 rounded-lg px-3 py-2 text-sm focus:outline-none focus:border-[#00896F]" />
                </div>
                <div class="w-1/3">
                  <label class="block text-xs text-gray-700 mb-1">ZIP Code</label>
                  <input v-model="profile.permanentAddress.zip" class="w-full bg-white border border-gray-200 rounded-lg px-3 py-2 text-sm focus:outline-none focus:border-[#00896F]" />
                </div>
              </div>
            </div>
          </div>
        ...
        <div v-if="isEditing || profile.communicationAddresses.some(a => a.street || a.city || a.state || a.zip)">
          <div class="flex justify-between items-center mb-4">
            <h4 class="text-sm text-gray-500">Communication Addresses</h4>
            <button v-if="isEditing" @click="addCommunicationAddress" class="text-xs text-[#00896F] font-medium hover:underline">+ Add Address</button>
          </div>
          
          <div class="space-y-3">
            <div v-for="(addr, index) in profile.communicationAddresses.filter(a => !isEditing ? (a.street || a.city || a.state || a.zip) : true)" :key="index" class="bg-[#F8FAF9] border border-[#E9F3F0] rounded-xl p-4 flex items-start gap-4">
              <div class="w-10 h-10 rounded-full bg-[#E6F6F2] flex items-center justify-center text-[#00896F] shrink-0 mt-1">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-5 h-5"><path stroke-linecap="round" stroke-linejoin="round" d="M21.75 6.75v10.5a2.25 2.25 0 0 1-2.25 2.25h-15a2.25 2.25 0 0 1-2.25-2.25V6.75m19.5 0A2.25 2.25 0 0 0 19.5 4.5h-15a2.25 2.25 0 0 0-2.25 2.25m19.5 0v.243a2.25 2.25 0 0 1-1.07 1.916l-7.5 4.615a2.25 2.25 0 0 1-2.36 0L3.32 8.91a2.25 2.25 0 0 1-1.07-1.916V6.75" /></svg>
              </div>
              ...
              <div v-else class="flex-1 space-y-4 py-1">
                <div class="flex justify-between gap-4">
                  <div class="flex-1">
                    ...
                    <input v-model="addr.label" placeholder="e.g. Address 1" class="w-full bg-white border border-gray-200 rounded-lg px-3 py-2 text-sm focus:outline-none focus:border-[#00896F]" />
                  </div>
                ...
                <div>
                  <label class="block text-xs text-gray-700 mb-1">Street Address</label>
                  <input v-model="addr.street" class="w-full bg-white border border-gray-200 rounded-lg px-3 py-2 text-sm focus:outline-none focus:border-[#00896F]" />
                </div>
                <div class="flex gap-4">
                  <div class="flex-1">
                    <label class="block text-xs text-gray-700 mb-1">City</label>
                    <input v-model="addr.city" class="w-full bg-white border border-gray-200 rounded-lg px-3 py-2 text-sm focus:outline-none focus:border-[#00896F]" />
                  </div>
                  <div class="w-1/3">
                    <label class="block text-xs text-gray-700 mb-1">State</label>
                    <input v-model="addr.state" class="w-full bg-white border border-gray-200 rounded-lg px-3 py-2 text-sm focus:outline-none focus:border-[#00896F]" />
                  </div>
                  <div class="w-1/3">
                    <label class="block text-xs text-gray-700 mb-1">ZIP Code</label>
                    <input v-model="addr.zip" class="w-full bg-white border border-gray-200 rounded-lg px-3 py-2 text-sm focus:outline-none focus:border-[#00896F]" />
                  </div>
                </div>
              </div>
            </div>
    ...
    <div class="bg-white rounded-2xl p-6 border border-gray-100 shadow-sm">
      <div class="flex justify-between items-center mb-6">
        ...
        <button v-if="isEditing" @click="openEntityModal()" class="text-sm text-[#00896F] font-medium hover:underline">+ Add Entity</button>
      </div>
      <div class="space-y-3">
        <div v-for="(entity, index) in profile.relatedEntities" :key="index" class="bg-[#F8FAF9] border border-[#E9F3F0] rounded-xl p-4 flex items-center justify-between gap-4 transition-all">
    ...
    <div class="bg-white rounded-2xl p-6 border border-gray-100 shadow-sm">
      <div class="flex justify-between items-center mb-6">
        ...
        <button v-if="isEditing" @click="openContactModal()" class="text-sm text-[#00896F] font-medium hover:underline">+ Add Contact</button>
      </div>
      <div class="space-y-3">
        <div v-for="(contact, index) in profile.keyContacts" :key="index" class="bg-[#F8FAF9] border border-[#E9F3F0] rounded-xl p-4 flex items-center justify-between gap-4 transition-all">
          <div class="flex items-center gap-4">
            <div class="w-10 h-10 rounded-full bg-[#004D40] flex items-center justify-center text-white text-sm font-medium shrink-0">
               {{ contact.initials }}
            </div>
            <div>
      ...
      <div class="bg-white rounded-2xl w-full max-w-md shadow-2xl">
        ...
        <div class="p-6 space-y-4">
          <div>
            ...
            <input v-model="entityModal.data.name" placeholder="Enter entity name" class="w-full bg-white border border-gray-200 rounded-lg px-3 py-2.5 text-sm focus:outline-none focus:border-[#00896F]" />
          </div>
          <div>
            <label class="block text-sm text-gray-700 mb-1">Entity Type</label>
            <select v-model="entityModal.data.type" class="w-full bg-white border border-gray-200 rounded-lg px-3 py-2.5 text-sm focus:outline-none focus:border-[#00896F] appearance-none">
          ...
          <div>
            ...
            <input v-model="entityModal.data.ein" placeholder="XX-XXXXXXX" class="w-full bg-white border border-gray-200 rounded-lg px-3 py-2.5 text-sm focus:outline-none focus:border-[#00896F]" />
          ...
          <div>
            ...
            <input v-model="entityModal.data.state" placeholder="e.g., Delaware, New York" class="w-full bg-white border border-gray-200 rounded-lg px-3 py-2.5 text-sm focus:outline-none focus:border-[#00896F]" />
          </div>
          <div>
            <label class="block text-sm text-gray-700 mb-1">Formation Date</label>
            <input type="date" v-model="entityModal.data.date" class="w-full bg-white border border-gray-200 rounded-lg px-3 py-2.5 text-sm focus:outline-none focus:border-[#00896F]" />
          </div>
      ...
      <div class="bg-white rounded-2xl w-full max-w-md max-h-[90vh] overflow-y-auto shadow-2xl">
        ...
        <div class="p-6 space-y-4">
          <div>
            ...
            <input v-model="contactModal.data.name" placeholder="Enter full name" class="w-full bg-white border border-gray-200 rounded-lg px-3 py-2.5 text-sm focus:outline-none focus:border-[#00896F]" />
          </div>
          <div>
            <label class="block text-sm text-gray-700 mb-1">Role / Position</label>
            <input v-model="contactModal.data.role" placeholder="e.g., CFO, Tax Manager" class="w-full bg-white border border-gray-200 rounded-lg px-3 py-2.5 text-sm focus:outline-none focus:border-[#00896F]" />
          </div>
          <div>
            ...
            <div class="relative">
              ...
              <input v-model="contactModal.data.email" type="email" placeholder="email@example.com" class="w-full pl-9 bg-white border border-gray-200 rounded-lg px-3 py-2.5 text-sm focus:outline-none focus:border-[#00896F]" />
            </div>
          </div>
          <div>
            ...
            <div class="relative">
               ...
               <input v-model="contactModal.data.phone" placeholder="(555) 123-4567" class="w-full pl-9 bg-white border border-gray-200 rounded-lg px-3 py-2.5 text-sm focus:outline-none focus:border-[#00896F]" />
            </div>
          </div>
          <div>
            <label class="block text-sm text-gray-700 mb-1">Department</label>
            <input v-model="contactModal.data.department" placeholder="e.g., Finance, Legal" class="w-full bg-white border border-gray-200 rounded-lg px-3 py-2.5 text-sm focus:outline-none focus:border-[#00896F]" />
          </div>
          <div>
            <label class="block text-sm text-gray-700 mb-1">Notes (Optional)</label>
            <textarea v-model="contactModal.data.notes" placeholder="Additional notes about this contact..." rows="3" class="w-full bg-white border border-gray-200 rounded-lg px-3 py-2.5 text-sm focus:outline-none focus:border-[#00896F] resize-none"></textarea>
          </div>
        </div>
