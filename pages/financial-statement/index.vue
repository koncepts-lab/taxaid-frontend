        ...
        <div v-if="!isFullScreenChat" class="h-screen font-sans flex overflow-hidden relative z-10"
            ...
            <div class="flex-1 overflow-y-auto no-scrollbar transition-all duration-500 ease-in-out p-8 pt-0" :class="isChatOpen
                ...
                <div class="mx-auto">
                    ...
                    <div class="flex gap-3 my-8 overflow-x-auto pb-2 no-scrollbar"
                        ...
                        <button v-for="tab in tabs" :key="tab.id" @click="activeTab = tab.id"
                            :class="[activeTab === tab.id
                                ...
                                : (isDark ? 'bg-primary-950/80 text-white/70' : 'bg-white text-gray-600'), currentLang === 'ar' ? 'pr-4' : 'pl-4']"
                    ...
                    <!-- Table Container -->
                    <div class="rounded-3xl py-8 shadow-sm border border-transparent min-h-[500px] mb-10"
