      ...
      <div
        ...
        <div class="flex items-center gap-4">
          ...
          <div>
            ...
            <p class="text-[14px] font-normal text-[#854D0E]">You have {CUST-005,CUST-007} customers with credit cards
              expiring within the next 30 days. Kindly reach out to them and ensure their payment details are updated.
            </p>
          </div>
        </div>
                  ...
                  <div class="flex justify-between items-center">
                    ...
                    <span class="text-[14px] font-medium flex items-center gap-1"
                      ...
                      <img v-if="label === 'Revenue:'" src="/images/icons/dirham-black.svg" alt="AED"
                        class="w-3.5 h-3.5" />
                      <img v-if="label === 'Collected:'" src="/images/icons/dirham-green.svg" alt="AED"
                        class="w-3.5 h-3.5" />
                      {{ val }}
                    </span>
                  </div>
      ...
      <div class="bg-white rounded-[24px] p-8 border border-[#0000001A] shadow-sm">
        ...
        <div class="flex flex-col md:flex-row items-center justify-between gap-4 mb-8">
          <div class="flex flex-wrap items-center gap-3 w-full">
            ...
            <button
              class="h-[44px] flex items-center gap-2 bg-[#A1FFE64D] border border-[#04C18F80] px-6 py-2 rounded-[6px] text-[#0A0A0A] font-medium text-[14px] hover:bg-[#A1FFE666] transition-colors cursor-pointer ml-auto">
              <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" fill="none" viewBox="0 0 24 24"
                stroke="currentColor">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                  d="M4 16v1a3 3 0 003 3h10a3 3 0 003-3v-1m-4-4l-4 4m0 0l-4-4m4 4V4" />
            ...
            <thead>
              <tr class="bg-[#00896F] text-white">
                ...
                <th class="px-6 py-4 font-normal text-[14px] relative">
                  <div @click="isPartnerMenuOpen = !isPartnerMenuOpen"
                    ...
                    <div class="space-y-2">
                      <div v-for="partnerName in ['Acme Partners', 'Beta Consulting']" :key="partnerName"
                        ...
                        <div class="w-6 h-6 rounded-[6px] flex items-center justify-center transition-all flex-shrink-0"
                          ...
                          <svg v-if="selectedPartners.includes(partnerName)" xmlns="http://www.w3.org/2000/svg"
                        ...
                        <span class="text-[14px] font-normal"
                          :class="selectedPartners.includes(partnerName) ? 'text-[#000]' : 'text-gray-700'">
                          {{ partnerName }}
                        </span>
                      </div>
                    </div>
