    ...
    <main class="flex-1 px-8 py-8 space-y-8 overflow-y-auto" style="margin-top: -18px;">
      ...
      <div class="flex items-center gap-8 py-2">
        ...
        <div class="flex items-center gap-4">
          ...
          <div class="flex items-center gap-3 px-6 h-[50px] bg-white rounded-[10px] border border-[#E5E5E5]" :class="isDark ? 'bg-white/5 border-white/10' : ''">
            <span class="text-[15px] font-normal text-[#1a1a1a] whitespace-nowrap" :class="isDark ? 'text-white' : ''">Thursday, 12 Feb 2026</span>
        ...
        <!-- Today Button -->
        <button class="px-7 h-[46px] rounded-[10px] border border-[#04C18F66] bg-white text-[15px] font-normal text-[#1a1a1a] hover:border-[#04C18F] transition-colors cursor-pointer ml-2"
                :class="isDark ? 'bg-white/5 text-white border-white/20' : ''">
          Today
        </button>

        <!-- Consultant Selection -->
        <div class="flex items-center gap-12 ml-6 px-6 h-[50px] bg-white rounded-[10px] border border-[#E5E5E5] cursor-pointer group transition-all" :class="isDark ? 'bg-white/5 border-white/10' : 'bg-white'">
          <span class="text-[15px] font-normal text-[#6C768A]" :class="isDark ? 'text-white/70' : ''">Select Consultant Name</span>
      ...
      <div :class="isDark ? 'bg-[#00141080] border-white/10' : 'bg-white border-[#F0F0F0]'" 
        ...
        <div class="p-8 pb-5 flex justify-between items-center">
          <h3 class="text-[20px] font-medium" :class="isDark ? 'text-white' : 'text-[#1a1a1a]'">Thursday, 12 Feb 2026</h3>
          <span class="text-[14px] font-regular opacity-60">3 Activities</span>
        </div>
          ...
          <div class="overflow-hidden rounded-[4px]">
            <table class="w-full text-left border-collapse">
              ...
              <tbody class="divide-y" :class="isDark ? 'divide-white/5' : 'divide-[#F0F0F0]'">
                <tr v-for="i in 2" :key="i" class="transition-colors" :class="isDark ? 'hover:bg-white/5' : 'hover:bg-gray-50/30'">
                  <td class="py-5 px-6 text-[14px] font-normal text-black" :class="isDark ? 'text-white' : ''">1:24:23 PM</td>
                  <td class="py-5 px-6 text-[14px] font-normal text-black" :class="isDark ? 'text-white' : ''">1:24:23 PM</td>
                  ...
                  <td class="py-5 px-6 text-[14px] font-normal text-black" :class="isDark ? 'text-white' : ''">C002</td>
                  <td class="py-5 px-6 text-[14px] font-normal text-black" :class="isDark ? 'text-white' : ''">Beta Industries</td>
                </tr>
              </tbody>
            </table>
          </div>
